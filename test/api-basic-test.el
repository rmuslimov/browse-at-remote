...
(ert-deftest get-git-repo-url-test ()
  ...
  (should (equal (browse-at-remote/get-url-from-origin "git@github.com:someplace_with_underscores/with_underscores.el.git")
...
(ert-deftest get-https-repo-url-test ()
  ...
  (should (equal (browse-at-remote/get-url-from-origin "https://github.com/with_underscores/pro-digy_underscores.el.git")
